        ...
        <form action="{{ route('harga.update', $harga) }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" class="
                  ...
                  " name="nama" value="{{ old('nama', $harga->nama) }}" required>
            ...
            <div class="mb-5">
                ...
                <input type="text" class="
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                  " name="kode" value="{{ old('kode', $harga->kode) }}" readonly>
            ...
            <div class="mb-5">
                ...
                <input type="text" class="
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                  " name="harga" value="{{ old('price', $harga->harga) }}" required>
            ...
            <div class="mb-5">
                ...
                <input type="text" class="
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none
                  " name="deskripsi" value="{{ old('stock', $harga->deskripsi) }}" required>
